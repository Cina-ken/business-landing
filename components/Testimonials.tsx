  ...
  const testimonials = [
    {
      ...
      quote: "Working with GrowthLab increased our lead generation by 340% in just 6 months. The ROI has been incredible.",
      avatar: "https://ui-avatars.com/api/?name=Sarah+Johnson&background=3B82F6&color=fff"
    },
    {
      name: "Michael Chen", 
      company: "Digital Dynamics",
      quote: "Their data-driven approach helped us identify our best customer segments and triple our conversion rate.",
      avatar: "https://ui-avatars.com/api/?name=Michael+Chen&background=10B981&color=fff"
    },
    {
      name: "Emma Rodriguez",
      company: "Retail Solutions Co.",
      quote: "Professional, results-focused, and always available. Our revenue grew 250% in the first year working together.",
